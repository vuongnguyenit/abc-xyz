(function ($) {
    $.fn.extend({
        ...
        akordeon: function (options) {
            var settings = $.extend({ expandedItem: 0, expandSpeed: 700, toggle: false, expandText: '&ndash;', collapseText: '+', buttons: true, hiddenItem: -1, itemsOrder: [] }, options);
            return this.each(function () {
                ...
                $('.akordeon-item-head-container', akordeon).hover(function () {
