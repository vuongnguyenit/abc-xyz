...
'</head>' ,
'<body>' ,
(isset($def->fbcode) && !empty($def->fbcode) ? $def->fbcode : '') ,
'<div id="wrapper">' ,  
  '<div id="page-wrapper">' , 
    '<div id="page">';
...
'<div class="mobile-call visible-xs"><a href="tel:+84988753595"><i class="fa fa-phone-square"></i></a></div>' ,
...
(isset($def->ga) && !empty($def->ga) ? $def->ga : '') ,
'</body>' ,
