...
function CheckAuthentication()
{
	...
	if(!empty($_SESSION['user']) && isset($_SESSION['user']) && isset($_SESSION['admission']))			
    	return true;
	else
		return false;
...
#$config['LicenseName'] = 'VuManhTrung';
#$config['LicenseKey'] = 'R4PXJF3QJ66T443JNS71WU3E68PNPHSK';
$config['LicenseName'] = 'PhuongNamSolution';
$config['LicenseKey'] = 'FQN9L7AE8MBJRT5GCWP18HQV5QB1AJTD';
...
*/
$baseUrl = 'http://' . $_SERVER['HTTP_HOST'] . '/media/uploads/';
$enabled = true;
/*
